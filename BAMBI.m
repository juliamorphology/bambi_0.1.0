...
[info.category info.value] = textread([DEMfile],'%s %f',5);
...
Easting = zeros(1,info.value(1,1)+1); %create zeros vector of the same size as the data
Northing = zeros(info.value(2,1)-1,1); %create zeros vector of the same size as the data
